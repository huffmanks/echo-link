...
function SidebarProvider({
  ...
  // Adds a keyboard shortcut "meta + b" to toggle the sidebar.
  useKeyboardShortcut(SIDEBAR_KEYBOARD_SHORTCUT, toggleSidebar, { mod: true });
...
function SidebarMenuAction({
  ...
  return useRender({
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          "aria-disabled:text-muted-foreground text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 cursor-pointer items-center justify-center rounded-md p-0 outline-hidden transition-colors transition-transform group-data-[collapsible=icon]:hidden peer-data-[size=default]/menu-button:top-1.5 peer-data-[size=lg]/menu-button:top-2.5 peer-data-[size=sm]/menu-button:top-1 after:absolute after:-inset-2 focus-visible:ring-2 aria-disabled:cursor-auto aria-disabled:hover:bg-transparent md:after:hidden [&>svg]:size-4 [&>svg]:shrink-0",
          showOnHover &&
